...
- Build a good graph generator; not the crappy one used to generate alternatives universes in dataset folder. A new project on itself.
- Transform explore step to leverage parallelism. Should be easy given the sqlite datasource allowing multi process to work concurrently natively.
