...
const DepthLevel2 = process.env.DEPTH_LEVEL_2 || Config.DepthLevel2 || 10;
...
const main = async function(){
	...
	try{
		...
		if(!process.argv[2]){
			...
			var pathFinder = new PathFinder(MFalcon, Empire, graph, HeapSizeLevel1, HeapSizeLevel2, DepthLevel2, SoftTimeoutSec);
