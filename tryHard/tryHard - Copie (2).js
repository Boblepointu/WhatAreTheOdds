...
var main = async function(){
	...
	var pathFinder = new PathFinder(dbReader, dataSet.MFalcon, dataSet.Empire);

	await pathFinder.buildGraph();
	var routesFound = await pathFinder.findRoutes();
	routesFound = routesFound.concat(await pathFinder.findRoutes(100000));
	console.log(`${routesFound.length}`)
